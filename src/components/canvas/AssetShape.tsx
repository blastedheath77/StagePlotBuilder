...
export const AssetShape: React.FC<AssetShapeProps> = ({ type, width, height }) => {
  const halfW = width / 2;
      ...
      return (
        <Group x={-halfW} y={-halfH}>
          ...
          <Circle
            ...
            fill="#3b82f6"
          />
          <Circle x={8} y={8} radius={3.5} fill="#3b82f6" opacity={0.6} />
          <Circle x={width - 8} y={8} radius={3.5} fill="#3b82f6" opacity={0.6} />
          <Circle x={8} y={height - 8} radius={3.5} fill="#3b82f6" opacity={0.6} />
          <Circle x={width - 8} y={height - 8} radius={3.5} fill="#3b82f6" opacity={0.6} />
        </Group>
      );
    ...
    case 'power_drop':
      return (
        <Group x={-halfW} y={-halfH}>
          ...
          />
          <Path
            data={`M ${width * 0.55} ${height * 0.18} L ${width * 0.32} ${height * 0.52} L ${width * 0.52} ${height * 0.52} L ${width * 0.42} ${height * 0.82} L ${width * 0.72} ${height * 0.44} L ${width * 0.52} ${height * 0.44} Z`}
            fill="#fbbf24"
            stroke="#f59e0b"
            strokeWidth={0.8}
          />
